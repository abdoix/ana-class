                      ...
                      if($arraif[0] == "all")
                      {
                        ...
                        while ($selectedOption = $villesearch->fetch())
                        {
                          ...
                          {                            
                            ...
                            {
                            echo "<div class='border p-2 bg-white' style='border-radius:10px;width:100%;'><div class='headings d-flex justify-content-center align-items-center mb-3'><h6>The result of <span class='font-weight-bold text-danger'>$selectedOption[0] </span>City</h6></div>";
                            echo "<div id='accord$cmpaccord' class='d-flex flex-column w-100' style='gap:1rem;overflow:auto;height:300px;'>";
                              echo "<div class='card w-100 shadow '>
